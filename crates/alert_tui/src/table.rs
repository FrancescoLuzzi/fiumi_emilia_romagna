...
use ratatui::{
    ...
    widgets::{
        ...
        ScrollbarState, StatefulWidget, StatefulWidgetRef, Table, TableState,
    },
};
...
fn render_table(buf: &mut Buffer, state: &mut SelectionPageState, area: Rect) {
    let header = [
        "Stazione",
        "Ultima rilevazione",
        "Soglia1",
...
fn render_footer(b: &mut Buffer, area: Rect) {
    ...
    ratatui::widgets::Widget::render(info_footer, area, b);
}
